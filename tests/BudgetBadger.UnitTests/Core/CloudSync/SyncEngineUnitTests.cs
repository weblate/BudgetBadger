...
{
    private SyncEngineEngine _syncEngineEngine { get; set; }
    ...
    public void Setup()
    {
        ...
        _syncEngineEngine = new SyncEngineEngine(_mergeLogic);
    }
    ...
    public async Task Import_MergeLogicThrowsException_ReturnsUnsuccessful()
    {
        ...
        // act
        var result = await _syncEngineEngine.ImportAsync(_sourceDataAccess, _targetDataAccess);
    ...
    public async Task Export_MergeLogicThrowsException_ReturnsUnsuccessful()
    {
        ...
        // act
        var result = await _syncEngineEngine.ExportAsync(_sourceDataAccess, _targetDataAccess);
    ...
    public async Task FileBasedImport_ImportFileSystemThrowsException_ReturnsUnsuccessful()
    {
        ...
        // act
        var result = await _syncEngineEngine.FileBasedImportAsync(_cloudFileSystem, string.Empty, false, _tempFileSystem,
    ...
    public async Task FileBasedImport_DecompressImportFileTrue_DecompressesImportFile()
    {
        ...
        // act
        await _syncEngineEngine.FileBasedImportAsync(_cloudFileSystem, string.Empty, true, _tempFileSystem,
            string.Empty, _tempDataAccess, _targetDataAccess); 

        // assert
        A.CallTo(() => _tempFileSystem.File.WriteAllBytesAsync(A<string>._, d)).MustHaveHappened();
    }
    ...
    public async Task FileBasedImport_DecompressImportFileFalse_DoesNotDecompressImportFile()
    {
        ...
        // act
        await _syncEngineEngine.FileBasedImportAsync(_cloudFileSystem, string.Empty, false, _tempFileSystem,
            string.Empty, _tempDataAccess, _targetDataAccess); 
    ...
    public async Task FileBasedExport_TempFileSystemThrowsException_ReturnsUnsuccessful()
    {
        ...
        // act
        var result = await _syncEngineEngine.FileBasedExportAsync(_sourceDataAccess, _tempDataAccess, _tempFileSystem,
            string.Empty, false, _cloudFileSystem, string.Empty);
    ...
    public async Task FileBasedExport_CompressTempFileTrue_CompressesTempFile()
    {
        ...
        // act
        await _syncEngineEngine.FileBasedExportAsync(_sourceDataAccess, _tempDataAccess, _tempFileSystem,
            string.Empty, true, _cloudFileSystem, string.Empty); 
